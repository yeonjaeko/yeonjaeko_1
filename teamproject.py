...
#
# weekend_sum = 3200000
# def parttimer (a) : # a 정산금 가격을 받아옴
#     parttime = 0  # 알바생 수는 돈을 줘야 생기므로 매번 0으로 초기화 됨
#     parttime = a // 1500000 # 알바생 수는 정산금을 150만으로 나눈 몫 만큼 생기게 됨.
#     a = a - 1500000*parttime # 알바생에게 선불금을 지급하고 남은 정산금
#     return [parttime,a]
#
# result = parttimer(weekend_sum)
# print(result[0]) # 알바생의 수
# print(result[1]) # 남은 정산금
# weekend_sum = result[1]
# parttime  = result[0]
#
#
# def ending(weekend_sum):
#     if weekend_sum > 500000000:
